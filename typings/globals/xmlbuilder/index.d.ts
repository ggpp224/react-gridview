...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/7de6c3dd94feaeb21f20054b9f30d5dabc5efabd/xmlbuilder/xmlbuilder.d.ts

declare module 'xmlbuilder' {
    export type XMLDocType = __XmlBuilder.XMLDocType;
    export type XMLElementOrXMLNode = __XmlBuilder.XMLElementOrXMLNode;
    export function create(name: string, xmldec?: Object, doctype?: any, options?: Object): XMLElementOrXMLNode;
}

declare module __XmlBuilder {
    class XMLDocType {
        clone(): XMLDocType;
